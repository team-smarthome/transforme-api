...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('petugas', function (Blueprint $table) {
            ...
            $table->uuid('pangkat_id')->nullable(false);
            $table->uuid('kesatuan_id')->nullable(false);
            ...
            $table->uuid('agama_id')->nullable(false);
            $table->uuid('status_kawin_id')->nullable(false);
            $table->uuid('pendidikan_id')->nullable(false);
            $table->uuid('bidang_keahlian_id')->nullable(false);
            ...
            $table->uuid('grup_petugas_id')->nullable(false);
            $table->string('nrp', 36)->nullable();
            $table->uuid('matra_id')->nullable(false);
