...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sidang', function (Blueprint $table) {
            ...
            $table->uuid('pengadilan_militer_id')->nullable(false);
            $table->string('agenda_sidang', 100)->nullable();
            $table->string('hasil_keputusan_sidang', 100)->nullable();
            $table->uuid('jenis_persidangan_id')->nullable(false);
            ...
            $table->foreign('pengadilan_militer_id')->references('id')->on('pengadilan_militer');
            $table->foreign('jenis_persidangan_id')->references('id')->on('jenis_persidangan');
