...
return new class extends Migration
{
    ...
    {
        Schema::create('registration_kios', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->string('nama_registration_kios', 100)->nullable();
            $table->string('gmac', 100)->nullable();
            $table->uuid('ruangan_otmil_id')->nullable();
            $table->uuid('ruangan_lemasmil_id')->nullable();
            $table->string('status_registration_kios', 100)->nullable();
            $table->string('v_registration_kios_topic', 100)->nullable();
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('registration_kios');
    }
};
