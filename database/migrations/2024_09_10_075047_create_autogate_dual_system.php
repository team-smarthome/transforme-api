...
return new class extends Migration
{
  ...
  {
    Schema::create('autogate_dual_system', function (Blueprint $table) {
      $table->uuid('id')->primary();
      $table->string('nama_autogate_dual', 100)->nullable();
      $table->string('gmac', 100)->nullable();
      $table->uuid('ruangan_otmil_id')->nullable();
      $table->uuid('ruangan_lemasmil_id')->nullable();
      $table->string('status_autogate_dual', 100)->nullable();
      $table->string('v_autogate_dual_topic', 100)->nullable();
      $table->timestamps();
      $table->softDeletes();
  ...
  {
    Schema::dropIfExists('autogate_dual_system');
  }
};
