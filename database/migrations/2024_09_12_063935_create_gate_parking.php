...
return new class extends Migration
{
  ...
  {
    Schema::create('gate_parking', function (Blueprint $table) {
      $table->uuid('id')->primary();
      $table->string('nama_gate_parking', 100)->nullable();
      $table->string('gmac', 100)->nullable();
      $table->uuid('ruangan_otmil_id')->nullable();
      $table->uuid('ruangan_lemasmil_id')->nullable();
      $table->string('status_gate_parking', 100)->nullable();
      $table->string('v_gate_parking_topic', 100)->nullable();
      $table->timestamps();
      $table->softDeletes();
  ...
  {
    Schema::dropIfExists('gate_parking');
  }
};
