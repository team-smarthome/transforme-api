...
class GateParkingResource extends JsonResource
{
  /**
  ...
  public function toArray(Request $request): array
  {
    ...
    return [
      'gate_parking_id' => $this->id, //
      'gmac' => $this->gmac, //
      'nama_gate_parking' => $this->nama_gate_parking, //
      'status_gate_parking' => $this->status_gate_parking, //
      'v_gate_parking_topic' => $this->v_gate_parking_topic, //
