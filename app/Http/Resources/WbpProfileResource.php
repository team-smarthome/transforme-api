...
class WbpProfileResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'nama_hunian_wbp_lemasmil' => $this->hunianWbpLemasmil->nama_hunian_wbp_lemasmil,
            'nama_hunian_wbp_otmil' => $this->hunianWbpOtmil->lokasiOtmil->nama_hunian_wbp_otmil,
            'lokasi_otmil_id' => $this->hunianWbpOtmil->lokasi_otmil_id,
            'lokasi_lemasmil_id' => $this->hunianWbpLemasmil->lokasiLemasmil->lokasi_lemasmil_id,
            'nama_lokasi_otmil' => $this->hunianWbpOtmil->lokasiOtmil->nama_lokasi_otmil,
            'nama_lokasi_lemasmil' => $this->hunianWbpLemasmil->lokasiLemasmil->nama_lokasi_lemasmil,
            ...
            'jenis_perkara_id' => $this->kasus->jenisPerkara->jenis_perkara_id,
            'nama_jenis_perkara' => $this->kasus->jenisPerkara->nama_jenis_perkara,
            'pasal' => $this->kasus->jenisPerkara->pasal,
            ...
            'kategori_perkara_id' => $this->kasus->jenisPerkara->kategoriPerkara->kategori_perkara_id,
            'nama_kategori_perkara' => $this->kasus->jenisPerkara->kategoriPerkara->nama_kategori_perkara,
            'DMAC' => $this->gelang->dmac,
            'nama_gelang' => $this->gelang->nama_gelang,
            'tanggal_pasang' => $this->gelang->tanggal_pasang,
            'tanggal_aktivasi' => $this->gelang->tanggal_aktivasi,
