...
class WbpProfileResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'nama_jenis_perkara' => $this->when($this->kasus, fn() => $this->kasus->jenisPerkara->nama_jenis_perkara),
            'pasal' => $this->when($this->kasus, fn() => $this->kasus->jenisPerkara->pasal),
            'vonis_tahun_perkara' => $this->when($this->kasus, fn() => $this->kasus->jenisPerkara->vonis_tahun_perkara),
            'vonis_bulan_perkara' => $this->when($this->kasus, fn() => $this->kasus->jenisPerkara->vonis_bulan_perkara),
            'vonis_hari_perkara' => $this->when($this->kasus, fn() => $this->kasus->jenisPerkara->vonis_hari_perkara),
            ...
            'kategori_perkara_id' => $this->when($this->kasus, fn() => $this->kasus->jenisPerkara->kategori_perkara_id),
            'nama_kategori_perkara' => $this->when($this->kasus, fn() => $this->kasus->jenisPerkara->kategoriPerkara->nama_kategori_perkara),
