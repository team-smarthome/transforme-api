...
class AutogateSingleResource extends JsonResource
{
  /**
  ...
  public function toArray(Request $request): array
  {
    ...
    return [
      'autogate_single_id' => $this->id, //
      'gmac' => $this->gmac, //
      'nama_autogate_single' => $this->nama_autogate_single, //
      'status_autogate_single' => $this->status_autogate_single, //
      'v_autogate_single_topic' => $this->v_autogate_single_topic, //
