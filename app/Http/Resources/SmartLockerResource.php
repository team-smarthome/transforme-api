...
class SmartLockerResource extends JsonResource
{
  /**
  ...
  public function toArray(Request $request): array
  {
    ...
    return [
      'smartlocker_id' => $this->id, //
      'gmac' => $this->gmac, //
      'nama_smartlocker' => $this->nama_smartlocker, //
      'status_smartlocker' => $this->status_smartlocker, //
      'v_smartlocker_topic' => $this->v_smartlocker_topic, //
