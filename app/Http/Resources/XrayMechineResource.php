...
class XrayMechineResource extends JsonResource
{
  /**
  ...
  public function toArray(Request $request): array
  {
    ...
    return [
      'xray_mechine_id' => $this->id, //
      'gmac' => $this->gmac, //
      'nama_xray_mechine' => $this->nama_xray_mechine, //
      'status_xray_mechine' => $this->status_xray_mechine, //
      'v_xray_mechine_topic' => $this->v_xray_mechine_topic, //
