...
class EmergencyPushButtonResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'emergency_push_button_id' => $this->id, //
            'gmac' => $this->gmac, //
            'nama_emergency_push_button' => $this->nama_emergency_push_button, //
            'status_emergency_push_button' => $this->status_emergency_push_button, //
            'v_emergency_push_button_topic' => $this->v_emergency_push_button_topic, //
