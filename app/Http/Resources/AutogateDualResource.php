...
class AutogateDualResource extends JsonResource
{
  /**
  ...
  public function toArray(Request $request): array
  {
    ...
    return [
      'autogate_dual_id' => $this->id, //
      'gmac' => $this->gmac, //
      'nama_autogate_dual' => $this->nama_autogate_dual, //
      'status_autogate_dual' => $this->status_autogate_dual, //
      'v_autogate_dual_topic' => $this->v_autogate_dual_topic, //
