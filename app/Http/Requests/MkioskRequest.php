...
class MkioskRequest extends FormRequest
{
    /**
    ...
    public function messages(): array {
        return [
            ...
            'nama_m_kiosk.required' => 'Nama Access Point harus diisi',
            'nama_m_kiosk.string' => 'Nama Access Point harus berupa string',
            ...
            'status_m_kiosk.string' => 'Status Access Point harus berupa string',
            'v_m_kiosk_topic.string' => 'V Access Point Topic harus berupa string'
        ];
    }
}
