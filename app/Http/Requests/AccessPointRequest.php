...
class AccessPointRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nama_access_point' => 'required|string',
            'ruangan_otmil_id' => 'nullable|string',
            'ruangan_lemasmil_id' => 'nullable|string',
            'status_access_point' => 'nullable|string',
            'v_access_point_topic' => 'nullable|string'
        ];
    }
    ...
    public function messages(): array {
        return [
            ...
            'nama_access_point.required' => 'Nama Access Point harus diisi',
            'nama_access_point.string' => 'Nama Access Point harus berupa string',
            ...
            'status_access_point.string' => 'Status Access Point harus berupa string',
            'v_access_point_topic.string' => 'V Access Point Topic harus berupa string'
        ];
    }
}
